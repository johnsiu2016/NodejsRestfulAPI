  ...
  if ("ontouchstart" in window) {
    var e,
      ...
      var t = Date.now(),
          ...
          c = u.nodeName,
          l = "A" === c,
          f = window.navigator.standalone && l && e.target.getAttribute("href");return s.time = t, s.x = i, s.y = r, !((!e.simulated && (n < 500 || n < 1500 && a[0] < 50 && a[1] < 50) || f) && (e.preventDefault(), e.stopPropagation(), !f)) && (f && (window.location = u.getAttribute("href")), void (u && u.classList && (u.classList.add("energize-focus"), window.setTimeout(function () {
...
function (e, t) {
  ...
  function n(e) {
    ...
    var r,
      ...
      return oe.css(e, t, "");
        ...
        l = (oe.cssNumber[t] || "px" !== c && +u) && je.exec(oe.css(e, t));if (l && l[3] !== c) {
    ...
    for (var o, s, a, u, c, d, p = t.createDocumentFragment(), h = [], g = 0, v = e.length; g < v; g++) {
      if (o = e[g], o || 0 === o) if ("object" === oe.type(o)) oe.merge(h, o.nodeType ? [o] : o);else if (Fe.test(o)) {
      ...
      if (i && oe.inArray(o, i) > -1) r && r.push(o);else if (c = oe.contains(o.ownerDocument, o), s = l(p.appendChild(o), "script"), c && f(s), n) for (d = 0; o = s[d++];) {
    ...
    }if (null == i && null == r ? (r = n, i = n = void 0) : null == r && ("string" == typeof n ? (r = i, i = void 0) : (r = i, i = n, n = void 0)), r === !1) r = h;else if (!r) return this;return 1 === o && (s = r, r = function r(e) {
    ...
    t = J.apply([], t);var r,
        ...
        h = p - 1,
        g = t[0],
        v = oe.isFunction(g);if (v || p > 1 && "string" == typeof g && !ie.checkClone && Be.test(g)) return e.each(function (r) {
      ...
      }if (a) for (c = s[s.length - 1].ownerDocument, oe.map(s, x), f = 0; f < a; f++) {
    ...
    var t = G,
        n = Ve[e];return n || (n = E(e, t), "none" !== n && n || (Ue = (Ue || oe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement), t = Ue[0].contentDocument, t.write(), t.close(), n = E(e, t), Ue.detach()), Ve[e] = n), n;
  }function S(e, t, n) {
    var i,
        r,
        o,
        s,
        a = e.style;return n = n || Qe(e), n && (s = n.getPropertyValue(t) || n[t], "" !== s || oe.contains(e.ownerDocument, e) || (s = oe.style(e, t)), !ie.pixelMarginRight() && Ge.test(s) && Ye.test(t) && (i = a.width, r = a.minWidth, o = a.maxWidth, a.minWidth = a.maxWidth = a.width = s, s = n.width, a.width = i, a.minWidth = r, a.maxWidth = o)), void 0 !== s ? s + "" : s;
  }function N(e, t) {
    ...
    var i = je.exec(t);return i ? Math.max(0, i[2] - (n || 0)) + (i[3] || "px") : t;
    ...
    var r = !0,
        ...
        s = Qe(t),
        a = "border-box" === oe.css(t, "boxSizing", !1, s);if (G.msFullscreenElement && e.top !== e && t.getClientRects().length && (o = Math.round(100 * t.getBoundingClientRect()[n])), o <= 0 || null == o) {
      if (o = S(t, n, s), (o < 0 || null == o) && (o = t.style[n]), Ge.test(o)) return o;r = a && (ie.boxSizingReliable() || o === t.style[n]), o = parseFloat(o) || 0;
    ...
    var i,
        ...
        p = e.style,
        h = e.nodeType && qe(e),
        g = ke.get(e, "fxshow");n.queue || (a = oe._queueHooks(e, "fx"), null == a.unqueued && (a.unqueued = 0, u = a.empty.fire, a.empty.fire = function () {
      a.unqueued || u();
      ...
      if (r = t[i], st.exec(r)) {
        if (delete t[i], o = o || "toggle" === r, r === (h ? "hide" : "show")) {
          if ("show" !== r || !g || void 0 === g[i]) continue;h = !0;
        }d[i] = g && g[i] || oe.style(e, i);
      } else c = void 0;
    }if (oe.isEmptyObject(d)) "inline" === ("none" === c ? k(e.nodeName) : c) && (p.display = c);else {
      g ? "hidden" in g && (h = g.hidden) : g = ke.access(e, "fxshow", {}), o && (g.hidden = !h), h ? oe(e).show() : f.done(function () {
        oe(e).hide();
      }), f.done(function () {
        var t;ke.remove(e, "fxshow");for (t in d) {
          oe.style(e, t, d[t]);
        }
      });for (i in d) {
    ...
    var i,
      ...
      delete u.elem;
        ...
        u = function u() {
      if (r) return !1;for (var t = rt || H(), n = Math.max(0, c.startTime + c.duration - t), i = n / c.duration || 0, o = 1 - i, s = 0, u = c.tweens.length; s < u; s++) {
        c.tweens[s].run(o);
      }return a.notifyWith(e, [c, o, n]), o < 1 && u ? n : (a.resolveWith(e, [c]), !1);
    },
        c = a.promise({ elem: e, props: oe.extend({}, t), opts: oe.extend(!0, { specialEasing: {}, easing: oe.easing._default }, n), originalProperties: t, originalOptions: n, startTime: rt || H(), duration: n.duration, tweens: [], createTween: function createTween(t, n) {
        var i = oe.Tween(e, c.opts, t, n, c.opts.specialEasing[t] || c.opts.easing);return c.tweens.push(i), i;
      ...
      if (i = M.prefilters[o].call(c, e, l, c.opts)) return oe.isFunction(i.stop) && (oe._queueHooks(c.elem, c.opts.queue).stop = oe.proxy(i.stop, i)), i;
    ...
    function r(a) {
      var u;return o[a] = !0, oe.each(e[a] || [], function (e, a) {
        ...
        s = e === kt;return r(t.dataTypes[0]) || !o["*"] && r("*");
  }function B(e, t) {
    var n,
        i,
    ...
    var r;if (oe.isArray(t)) oe.each(t, function (t, r) {
      n || Lt.test(e) ? i(e, r) : U(e + "[" + ("object" == (typeof r === "undefined" ? "undefined" : _typeof(r)) && null != r ? t : "") + "]", r, n, i);
    ...
    var e,
        ...
        a = 1,
        u = arguments.length,
        c = !1;for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == (typeof s === "undefined" ? "undefined" : _typeof(s)) || oe.isFunction(s) || (s = {}), a === u && (s = this, a--); a < u; a++) {
      ...
      var n, i, r;if ("string" == typeof t && (n = e[t], t = e, e = n), oe.isFunction(e)) return i = Q.call(arguments, 2), r = function r() {
  ...
  function (e) {
    function t(e, t, n, i) {
      var r,
          ...
          p,
          h = t && t.ownerDocument,
          g = t ? t.nodeType : 9;if (n = n || [], "string" != typeof e || !e || 1 !== g && 9 !== g && 11 !== g) return n;if (!i && ((t ? t.ownerDocument || t : I) !== q && D(t), t = t || q, H)) {
        if (11 !== g && (c = me.exec(e))) if (r = c[1]) {
          if (9 === g) {
          ...
          if (c[2]) return K.apply(n, t.getElementsByTagName(e)), n;if ((r = c[3]) && w.getElementsByClassName && t.getElementsByClassName) return K.apply(n, t.getElementsByClassName(r)), n;
      ...
      var n = t && e,
          i = n && 1 === e.nodeType && 1 === t.nodeType && (~t.sourceIndex || V) - (~e.sourceIndex || V);if (i) return i;if (n) for (; n = n.nextSibling;) {
        if (n === t) return -1;
      }return e ? 1 : -1;
    }function a(e) {
      return function (t) {
      ...
      var i = t.dir,
        ...
        var a,
          ...
          if (1 === t.nodeType || r) {
            if (c = t[M] || (t[M] = {}), u = c[t.uniqueID] || (c[t.uniqueID] = {}), (a = u[i]) && a[0] === $ && a[1] === o) return l[2] = a[2];if (u[i] = l, l[2] = e(t, n, s)) return !0;
          }
        }
      };
    }function h(e) {
      ...
      return r && !r[M] && (r = m(r)), o && !o[M] && (o = m(o, s)), i(function (i, s, a, u) {
        var c,
            ...
            x = n ? o || (i ? e : h || r) ? [] : s : y;if (n && n(y, x, a, u), r) for (c = v(x, p), r(c, [], a, u), l = c.length; l--;) {
          (f = c[l]) && (x[p[l]] = !(y[p[l]] = f));
        }if (i) {
          if (o || e) {
            if (o) {
      ...
      for (var t, n, i, r = e.length, o = C.relative[e[0].type], s = o || C.relative[" "], a = o ? 1 : 0, u = p(function (e) {
        ...
        var r = !o && (i || n !== A) || ((t = n).nodeType ? u(e, n, i) : c(e, n, i));return t = null, r;
      }]; a < r; a++) {
        if (n = C.relative[e[a].type]) l = [p(h(l), n)];else {
      ...
      var r = n.length > 0,
        ...
        var l,
            ...
            w = x.length;for (c && (A = _s === q || _s || c); h !== w && null != (l = x[h]); h++) {
          if (o && l) {
            for (f = 0, _s || l.ownerDocument === q || (D(l), a = !H); d = e[f++];) {
              if (d(l, _s || q, a)) {
                u.push(l);break;
              }
            }c && ($ = b);
      ...
      var t,
          n,
          i = e ? e.ownerDocument || e : I;return i !== q && 9 === i.nodeType && i.documentElement ? (q = i, O = q.documentElement, H = !E(q), (n = q.defaultView) && n.top !== n && (n.addEventListener ? n.addEventListener("unload", Ce, !1) : n.attachEvent && n.attachEvent("onunload", Ce)), w.attributes = r(function (e) {
        ...
        var t = q.createElement("input");t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("name", "D"), e.querySelectorAll("[name=d]").length && _.push("name" + ne + "*[*^$|!~]?="), e.querySelectorAll(":enabled").length || _.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), _.push(",.*:");
        ...
        if (e === t) return j = !0, 0;var n = !e.compareDocumentPosition - !t.compareDocumentPosition;return n ? n : (n = (e.ownerDocument || e) === (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1, 1 & n || !w.sortDetached && t.compareDocumentPosition(e) === n ? e === q || e.ownerDocument === I && R(I, e) ? -1 : t === q || t.ownerDocument === I && R(I, t) ? 1 : L ? ee(L, e) - ee(L, t) : 0 : 4 & n ? -1 : 1);
      } : function (e, t) {
        if (e === t) return j = !0, 0;var n,
            ...
            o = t.parentNode,
            a = [e],
            u = [t];if (!r || !o) return e === q ? -1 : t === q ? 1 : r ? -1 : o ? 1 : L ? ee(L, e) - ee(L, t) : 0;if (r === o) return s(e, t);for (n = e; n = n.parentNode;) {
          a.unshift(n);
      ...
      if ((e.ownerDocument || e) !== q && D(e), n = n.replace(le, "='$1']"), w.matchesSelector && H && !z[n + " "] && (!P || !P.test(n)) && (!_ || !_.test(n))) try {
      ...
      (e.ownerDocument || e) !== q && D(e);var n = C.attrHandle[t.toLowerCase()],
          i = n && Y.call(C.attrHandle, t.toLowerCase()) ? n(e, t, !H) : void 0;return void 0 !== i ? i : w.attributes || !H ? e.getAttribute(t) : (i = e.getAttributeNode(t)) && i.specified ? i.value : null;
    }, t.error = function (e) {
      ...
      var t,
          n = [],
          i = 0,
          r = 0;if (j = !w.detectDuplicates, L = !w.sortStable && e.slice(0), e.sort(U), j) {
        for (; t = e[r++];) {
          t === e[r] && (i = n.push(r));
        }for (; i--;) {
          e.splice(n[i], 1);
      ...
      var t,
        ...
        n += T(t);
          ...
          var t,
              n = !e[6] && e[2];return pe.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && fe.test(n) && (t = k(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t), e[2] = n.slice(0, t)), e.slice(0, 3));
          ...
          var o = "nth" !== e.slice(0, 3),
            ...
            var c,
              ...
              } else if (y && (d = t, f = d[M] || (d[M] = {}), l = f[d.uniqueID] || (f[d.uniqueID] = {}), c = l[e] || [], p = c[0] === $ && c[1], x = p), x === !1) for (; (d = ++p && d && d[g] || (x = p = 0) || h.pop()) && ((a ? d.nodeName.toLowerCase() !== m : 1 !== d.nodeType) || !++x || (y && (f = d[M] || (d[M] = {}), l = f[d.uniqueID] || (f[d.uniqueID] = {}), l[e] = [$, x]), d !== t));) {}return x -= r, x === i || x % i === 0 && x / i >= 0;
            }
          };
        }, PSEUDO: function PSEUDO(e, n) {
          var r,
              o = C.pseudos[e] || C.setFilters[e.toLowerCase()] || t.error("unsupported pseudo: " + e);return o[M] ? o(n) : o.length > 1 ? (r = [e, e, "", n], C.setFilters.hasOwnProperty(e.toLowerCase()) ? i(function (e, t) {
          ...
          var t = [],
              n = [],
              r = S(e.replace(ae, "$1"));return r[M] ? i(function (e, t, n, i) {
      ...
      var i,
          ...
          u,
          c,
          l = X[e + " "];if (l) return n ? 0 : l.slice(0);for (a = e, u = [], c = C.preFilter; a;) {
      ...
      var r,
          ...
          f = !i && k(e = c.selector || e);if (n = n || [], 1 === f.length) {
        if (o = f[0] = f[0].slice(0), o.length > 2 && "ID" === (s = o[0]).type && w.getById && 9 === t.nodeType && H && C.relative[o[1].type]) {
          if (t = (C.find.ID(s.matches[0].replace(be, we), t) || [])[0], !t) return n;c && (t = t.parentNode), e = e.slice(o.shift().value.length);
  ...
  }(e);oe.find = le, oe.expr = le.selectors, oe.expr[":"] = oe.expr.pseudos, oe.uniqueSort = oe.unique = le.uniqueSort, oe.text = le.getText, oe.isXMLDoc = le.isXML, oe.contains = le.contains;var fe = function fe(e, t, n) {
    ...
    var i, r;if (!e) return this;if (n = n || ve, "string" == typeof e) {
      if (i = "<" === e[0] && ">" === e[e.length - 1] && e.length >= 3 ? [null, e, null] : me.exec(e), !i || !i[1] && t) return !t || t.jquery ? (t || n).find(e) : this.constructor(t).find(e);if (i[1]) {
        if (t = t instanceof oe ? t[0] : t, oe.merge(this, oe.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : G, !0)), he.test(i[1]) && oe.isPlainObject(t)) for (i in t) {
  ...
  }, oe.ready.promise();var Te = function Te(e, t, n, i, r, o, s) {
    var a = 0,
        u = e.length,
        c = null == n;if ("object" === oe.type(n)) {
      r = !0;for (a in n) {
        Te(e, t, a, n[a], !0, o, s);
      }
    } else if (void 0 !== i && (r = !0, oe.isFunction(i) || (s = !0), c && (s ? (t.call(e, i), t = null) : (c = t, t = function t(e, _t2, n) {
    ...
    return 1 === e.nodeType || 9 === e.nodeType || !+e.nodeType;
      ...
      if (!Ee(e)) return {};var t = e[this.expando];return t || (t = {}, Ee(e) && (e.nodeType ? e[this.expando] = t : Object.defineProperty(e, this.expando, { value: t, configurable: !0 }))), t;
      ...
      var n,
        ...
        var n, i;if (o && void 0 === t) {
          if (n = Se.get(o, e) || Se.get(o, e.replace(Ae, "-$&").toLowerCase()), void 0 !== n) return n;if (i = oe.camelCase(e), n = Se.get(o, i), void 0 !== n) return n;if (n = u(o, i, void 0), void 0 !== n) return n;
        } else i = oe.camelCase(e), this.each(function () {
          var n = Se.get(this, i);Se.set(this, i, t), e.indexOf("-") > -1 && void 0 !== n && Se.set(this, e, t);
        });
      ...
      var i;if (e) return t = (t || "fx") + "queue", i = ke.get(e, t), n && (!i || oe.isArray(n) ? i = ke.access(e, t, oe.makeArray(n)) : i.push(n)), i || [];
      ...
      var n = t + "queueHooks";return ke.get(e, n) || ke.access(e, n, { empty: oe.Callbacks("once memory").add(function () {
    ...
    var e = G.createDocumentFragment(),
        ...
        n = G.createElement("input");n.setAttribute("type", "radio"), n.setAttribute("checked", "checked"), n.setAttribute("name", "t"), t.appendChild(n), ie.checkClone = t.cloneNode(!0).cloneNode(!0).lastChild.checked, t.innerHTML = "<textarea>x</textarea>", ie.noCloneChecked = !!t.cloneNode(!0).lastChild.defaultValue;
  }();var Re = /^key/,
      ...
      var o,
          ...
          h,
          g,
          v = ke.get(e);if (v) for (n.handler && (o = n, n = o.handler, r = o.selector), n.guid || (n.guid = oe.guid++), (u = v.events) || (u = v.events = {}), (s = v.handle) || (s = v.handle = function (t) {
      ...
      var o,
          ...
          h,
          g,
          v = ke.hasData(e) && ke.get(e);if (v && (u = v.events)) {
      ...
      e = oe.event.fix(e);var t,
          ...
          c = oe.event.special[e.type] || {};if (a[0] = e, e.delegateTarget = this, !c.preDispatch || c.preDispatch.call(this, e) !== !1) {
      ...
      if (e[oe.expando]) return e;var t,
          ...
          r = e.type,
          o = e,
          s = this.fixHooks[r];for (s || (this.fixHooks[r] = s = Me.test(r) ? this.mouseHooks : Re.test(r) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, e = new oe.Event(o), t = i.length; t--;) {
        n = i[t], e[n] = o[n];
    ...
    return this instanceof oe.Event ? (e && e.type ? (this.originalEvent = e, this.type = e.type, this.isDefaultPrevented = e.defaultPrevented || void 0 === e.defaultPrevented && e.returnValue === !1 ? p : h) : this.type = e, t && oe.extend(this, t), this.timeStamp = e && e.timeStamp || oe.now(), void (this[oe.expando] = !0)) : new oe.Event(e, t);
      ...
      var e = this.originalEvent;this.isDefaultPrevented = p, e && e.preventDefault();
    }, stopPropagation: function stopPropagation() {
      var e = this.originalEvent;this.isPropagationStopped = p, e && e.stopPropagation();
    }, stopImmediatePropagation: function stopImmediatePropagation() {
      var e = this.originalEvent;this.isImmediatePropagationStopped = p, e && e.stopImmediatePropagation(), this.stopPropagation();
    ...
    oe.event.special[e] = { delegateType: t, bindType: t, handle: function handle(e) {
      ...
      var i,
          ...
          s,
          a = e.cloneNode(!0),
          u = oe.contains(e.ownerDocument, e);if (!(ie.noCloneChecked || 1 !== e.nodeType && 11 !== e.nodeType || oe.isXMLDoc(e))) for (s = l(a), o = l(e), i = 0, r = o.length; i < r; i++) {
        w(o[i], s[i]);
      }if (t) if (n) for (o = o || l(e), s = s || l(a), i = 0, r = o.length; i < r; i++) {
        b(o[i], s[i]);
      } else b(e, a);return s = l(a, "script"), s.length > 0 && f(s, !u && l(e, "script")), a;
      ...
      return Te(this, function (e) {
        var t = this[0] || {},
            n = 0,
            i = this.length;if (void 0 === e && 1 === t.nodeType) return t.innerHTML;if ("string" == typeof e && !We.test(e) && !Pe[(He.exec(e) || ["", ""])[1].toLowerCase()]) {
      ...
      var e = [];return C(this, arguments, function (t) {
        var n = this.parentNode;oe.inArray(this, e) < 0 && (oe.cleanData(l(this)), n && n.replaceChild(t, this));
      }, e);
    ...
    function t() {
      a.style.cssText = "-webkit-box-sizing:border-box;-moz-box-sizing:border-box;box-sizing:border-box;position:relative;display:block;margin:auto;border:1px;padding:1px;top:1%;width:50%", a.innerHTML = "", Ke.appendChild(s);var t = e.getComputedStyle(a);n = "1%" !== t.top, o = "2px" === t.marginLeft, i = "4px" === t.width, a.style.marginRight = "50%", r = "4px" === t.marginRight, Ke.removeChild(s);
        ...
        a = G.createElement("div");a.style && (a.style.backgroundClip = "content-box", a.cloneNode(!0).style.backgroundClip = "", ie.clearCloneStyle = "content-box" === a.style.backgroundClip, s.style.cssText = "border:0;width:8px;height:0;top:0;left:-9999px;padding:0;margin-top:1px;position:absolute", s.appendChild(a), oe.extend(ie, { pixelPosition: function pixelPosition() {
        return t(), n;
      ...
      nt = ["Webkit", "O", "Moz", "ms"],
      it = G.createElement("div").style;oe.extend({ cssHooks: { opacity: { get: function get(e, t) {
          if (t) {
    ...
    oe.cssHooks[t] = { get: function get(e, n, i) {
        ...
        var r,
            o = i && Qe(e),
            s = i && j(e, t, i, "border-box" === oe.css(e, "boxSizing", !1, o), o);return s && (r = je.exec(n)) && "px" !== (r[3] || "px") && (e.style[t] = n, n = oe.css(e, t)), L(e, n, s);
      } };
  }), oe.cssHooks.marginLeft = N(ie.reliableMarginLeft, function (e, t) {
    if (t) return (parseFloat(S(e, "marginLeft")) || e.getBoundingClientRect().left - Je(e, { marginLeft: 0 }, function () {
      return e.getBoundingClientRect().left;
    })) + "px";
  }), oe.cssHooks.marginRight = N(ie.reliableMarginRight, function (e, t) {
    if (t) return Je(e, { display: "inline-block" }, S, [e, "marginRight"]);
    ...
    } }), oe.Tween = O, O.prototype = { constructor: O, init: function init(e, t, n, i, r, o) {
    ...
    }, _default: "swing" }, oe.fx = O.prototype.init, oe.fx.step = {};var rt,
      ot,
      st = /^(?:toggle|show|hide)$/,
      at = /queueHooks$/;oe.Animation = oe.extend(M, { tweeners: { "*": [function (e, t) {
        var n = this.createTween(e, t);return c(n.elem, e, je.exec(t), n), n;
    ...
    var i = e && "object" == (typeof e === "undefined" ? "undefined" : _typeof(e)) ? oe.extend({}, e) : { complete: n || !n && t || oe.isFunction(e) && e, duration: e, easing: n && t || t && !oe.isFunction(t) && t };return i.duration = oe.fx.off ? 0 : "number" == typeof i.duration ? i.duration : i.duration in oe.fx.speeds ? oe.fx.speeds[i.duration] : oe.fx.speeds._default, null != i.queue && i.queue !== !0 || (i.queue = "fx"), i.old = i.complete, i.complete = function () {
      ...
      var r = oe.isEmptyObject(e),
          o = oe.speed(t, n, i),
          s = function s() {
        var t = M(this, oe.extend({}, e), o);(r || ke.get(this, "finish")) && t.stop(!0);
      ...
      var i = function i(e) {
        ...
        var t = !0,
            ...
            o = oe.timers,
            s = ke.get(this);if (r) s[r] && s[r].stop && i(s[r]);else for (r in s) {
    ...
    var e = G.createElement("input"),
        ...
        n = t.appendChild(G.createElement("option"));e.type = "checkbox", ie.checkOn = "" !== e.value, ie.optSelected = n.selected, t.disabled = !0, ie.optDisabled = !n.disabled, e = G.createElement("input"), e.value = "t", e.type = "radio", ie.radioValue = "t" === e.value;
  }();var ut,
      ct = oe.expr.attrHandle;oe.fn.extend({ attr: function attr(e, t) {
    ...
    var n = ct[t] || oe.find.attr;ct[t] = function (e, t, i) {
      ...
      var i,
          ...
          var t = oe.find.attr(e, "tabindex");return t ? parseInt(t, 10) : lt.test(e.nodeName) || ft.test(e.nodeName) && e.href ? 0 : -1;
    ...
    oe.propFix[this.toLowerCase()] = this;
      ...
      var n = typeof e === "undefined" ? "undefined" : _typeof(e);return "boolean" == typeof t && "string" === n ? t ? this.addClass(e) : this.removeClass(e) : oe.isFunction(e) ? this.each(function (n) {
        ...
        } else void 0 !== e && "boolean" !== n || (t = I(this), t && ke.set(this, "__className__", t), this.setAttribute && this.setAttribute("class", t || e === !1 ? "" : ke.get(this, "__className__") || ""));
      });
    ...
    } });var pt = /\r/g;oe.fn.extend({ val: function val(e) {
      var t,
          n,
          i,
          r = this[0];{
  ...
  });var ht = /^(?:focusinfocus|focusoutblur)$/;oe.extend(oe.event, { trigger: function trigger(t, n, i, r) {
      var o,
          s,
          a,
          u,
          ...
          h = ne.call(t, "namespace") ? t.namespace.split(".") : [];if (s = a = i = i || G, 3 !== i.nodeType && 8 !== i.nodeType && !ht.test(p + oe.event.triggered) && (p.indexOf(".") > -1 && (h = p.split("."), p = h.shift(), h.sort()), c = p.indexOf(":") < 0 && "on" + p, t = t[oe.expando] ? t : new oe.Event(p, "object" == (typeof t === "undefined" ? "undefined" : _typeof(t)) && t), t.isTrigger = r ? 2 : 3, t.namespace = h.join("."), t.rnamespace = t.namespace ? new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, t.result = void 0, t.target || (t.target = i), n = null == n ? [t] : oe.makeArray(n, [t]), f = oe.event.special[p] || {}, r || !f.trigger || f.trigger.apply(i, n) !== !1)) {
    ...
    var n = function n(e) {
      oe.event.simulate(t, e.target, oe.event.fix(e));
        ...
        var i = this.ownerDocument || this,
            r = ke.access(i, t);r || i.addEventListener(e, n, !0), ke.access(i, t, (r || 0) + 1);
      }, teardown: function teardown() {
        var i = this.ownerDocument || this,
            r = ke.access(i, t) - 1;r ? ke.access(i, t, r) : (i.removeEventListener(e, n, !0), ke.remove(i, t));
      } };
  });var gt = e.location,
      vt = oe.now(),
    ...
    var n,
      ...
      return this.map(function () {
        ...
        var e = this.type;return this.name && !oe(this).is(":disabled") && qt.test(this.nodeName) && !Dt.test(e) && (this.checked || !Oe.test(e));
      }).map(function (e, t) {
    ...
    try {
      ...
      Ht = oe.ajaxSettings.xhr();ie.cors = !!Ht && "withCredentials" in Ht, ie.ajax = Ht = !!Ht, oe.ajaxTransport(function (t) {
    var _n, i;if (ie.cors || Ht && !t.crossDomain) return { send: function send(r, o) {
        var s,
          ...
          return function () {
            _n && (_n = i = a.onload = a.onerror = a.onabort = a.onreadystatechange = null, "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? o(0, "error") : o(a.status, a.statusText) : o(Ot[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? { binary: a.response } : { text: a.responseText }, a.getAllResponseHeaders()));
          };
    ...
    if (e.crossDomain) {
      ...
      var e = _t.pop() || oe.expando + "_" + vt++;return this[e] = !0, e;
    ...
    if (!e || "string" != typeof e) return null;"boolean" == typeof t && (n = t, t = !1), t = t || (ie.createHTMLDocument ? G.implementation.createHTMLDocument("") : G);var i = he.exec(e),
    ...
    return oe.grep(oe.timers, function (t) {
      ...
      if (arguments.length) return void 0 === e ? this : this.each(function (t) {
        oe.offset.setOffset(this, e, t);
          ...
          i = this[0],
          r = { top: 0, left: 0 },
          o = i && i.ownerDocument;if (o) return t = o.documentElement, oe.contains(t, i) ? (r = i.getBoundingClientRect(), n = V(o), { top: r.top + n.pageYOffset - t.clientTop, left: r.left + n.pageXOffset - t.clientLeft }) : r;
    ...
    var n = "pageYOffset" === t;oe.fn[e] = function (i) {
      return Te(this, function (e, i, r) {
        var o = V(e);return void 0 === r ? o ? o[t] : e[i] : void (o ? o.scrollTo(n ? o.pageXOffset : r, n ? r : o.pageYOffset) : e[i] = r);
    ...
    oe.each({ padding: "inner" + e, content: t, "": "outer" + e }, function (n, i) {
      oe.fn[i] = function (i, r) {
        var o = arguments.length && (n || "boolean" != typeof i),
            s = n || (i === !0 || r === !0 ? "margin" : "border");return Te(this, function (t, n, i) {
    ...
    return oe;
      ...
      Mt = e.$;return oe.noConflict = function (t) {
  ...
  */
  var t = 0,
    ...
    var r,
        ...
        a,
        u = {},
        c = t.split(".")[0];return t = t.split(".")[1], r = c + "-" + t, i || (i = n, n = e.Widget), e.expr[":"][r.toLowerCase()] = function (t) {
      return !!e.data(t, r);
      ...
      var r,
        ...
        function a() {
          if (t || o.options.disabled !== !0 && !e(this).hasClass("ui-state-disabled")) return ("string" == typeof s ? o[s] : s).apply(o, arguments);
            ...
            l = u[2];l ? r.delegate(l, c, a) : n.bind(c, a);
      });
...
function (e) {
  ...
  var r = "tocify",
      ...
      var n = this,
          ...
          r = n.element.find("li[data-unique='" + i + "']");return i.length ? (n.element.find("." + n.focusClass).removeClass(n.focusClass), r.addClass(n.focusClass), n.options.showAndHide && r.click()) : (n.element.find("." + n.focusClass).removeClass(n.focusClass), !i.length && e && n.options.highlightDefault && n.element.find(p).first().addClass(n.focusClass)), n;
      ...
      var i = e(this).index(t.options.selectors),
          ...
          s = +r.prop("tagName").charAt(1);o < s ? t.element.find(f + "[data-tag=" + o + "]").last().append(t._nestElements(e(this), i)) : o === s ? n.find(p).last().after(t._nestElements(e(this), i)) : n.find(p).last().after(e("<ul/>", { "class": l, "data-tag": o })).next(f).append(t._nestElements(e(this), i));
      ...
      var r = this;this.element.on("click.tocify", "li", function () {
        ...
        e("html, body").promise().done(function () {
          var o,
              ...
              l = e(t).height(),
              f = e(n).height(),
              d = e("body")[0].scrollHeight;if (r.options.extendPage && (r.webkit && c >= d - l - r.options.extendPageOffset || !r.webkit && l + c > f - r.options.extendPageOffset) && !e(g).length) {
            if (s = e('div[data-unique="' + e(p).last().attr("data-unique") + '"]'), !s.length) return;a = s.offset().top, e(r.options.context).append(e("<div />", { "class": h, height: Math.abs(a - c) + "px", "data-unique": h })), r.extendPageScroll && (u = r.element.find("li.active"), r._scrollTo(e("div[data-unique=" + u.attr("data-unique") + "]")));
          }setTimeout(function () {
            var s,
              ...
              r.element.find("." + r.focusClass).removeClass(r.focusClass), o.addClass(r.focusClass);var c = r.tocifyWrapper,
                  l = e(o).closest(".tocify-header"),
                  f = l.offset().top,
                  d = c.offset().top,
                  p = f - d;if (p >= e(t).height()) {
                var h = p + c.scrollTop();c.scrollTop(h);
              } else p < 0 && c.scrollTop(0);
      ...
      var n = this;if (!t.is(":visible")) switch (t.find(f).length || t.parent().is(c) || t.parent().is(":visible") ? t.children(f).length || t.parent().is(c) || (t = t.closest(f)) : t = t.parents(f).add(t), n.options.showEffect) {case "none":
          ...
          t.show();}return t.parent().is(c) ? n.hide(e(f).not(t)) : n.hide(e(f).not(t.closest(c).find(f).not(t.siblings()))), n;
      ...
      var n = this;return e.parent().is(c) || e.next().is(f) ? n.show(e.next(f), t) : e.parent().is(f) && n.show(e.parent(), t), n;
...
function () {
  ...
  function i(e, t) {
    ...
    if (!(this instanceof s)) return new s(e, t);"string" == typeof e && (e = document.querySelectorAll(e)), this.elements = o(e), this.options = i({}, this.options), "function" == typeof t ? n = t : i(this.options, t), n && this.on("always", n), this.getImages(), c && (this.jqDeferred = new c.Deferred());var r = this;setTimeout(function () {
      r.check();
    });
  }function a(e) {
    this.img = e;
    ...
    var n = new s(this, e, t);return n.jqDeferred.promise(c(this));
  }), a.prototype = new t(), a.prototype.check = function () {
    var e = p[this.img.src] || new u(this.img.src);if (e.isConfirmed) return void this.confirm(e.isLoaded, "cached was confirmed");if (this.img.complete && void 0 !== this.img.naturalWidth) return void this.confirm(0 !== this.img.naturalWidth, "naturalWidth");var t = this;e.on("confirm", function (e, n) {
